...
import { KOSULLAR } from "@/lib/hukuki/kosullar";

// (P113) `/kosullar` — SABIT, PUBLIC adres.
//
// NEDEN SABIT: bu adres App Store Connect'e ve Google Play'e girilir; bir
// daha degismemesi gerekir. Tenant kapsamli (`/site/<slug>/kosullar`) bir
...
export async function generateMetadata(): Promise<Metadata> {
  const belge = KOSULLAR[await dilCoz()];
...
export default async function KosullarSayfasi() {
  return <HukukiBelge belge={KOSULLAR[await dilCoz()]} />;
}
