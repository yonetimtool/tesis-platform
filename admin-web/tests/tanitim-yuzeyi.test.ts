...
describe("(P127) konak -> yuzey", () => {
  ...
  it("(P154) ETIKET SINIRI: gevsek eslesme YOK", () => {
    // Ilk etiket TAM `app`/`panel` olmali; `includes("app")` gibi gevsek
    // bir kural bunlari da tesis sayardi.
    ...
    // Ilk etiketi app/panel OLMAYAN her konak TANITIM kalir.
    expect(konakYuzeyi("bilgi.example.com")).toBe("tanitim");
  });
