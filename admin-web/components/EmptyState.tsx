...
export function EmptyState({
  ...
  return (
    <div className="flex flex-col items-center justify-center gap-3 px-6 py-12 text-center">
      {/* (P244 §10) Eski Tailwind alfa sinifi -> token. `color-mix` tema
          degisince tinti de birlikte tasir; alfa sinifi token
          katmanindan BAGIMSIZ davraniyordu. */}
      <span
        className="flex h-12 w-12 items-center justify-center rounded-ikon"
        style={{
          background: "color-mix(in srgb, var(--yz-accent) 14%, transparent)",
          color: "var(--yz-accent-edge)",
        }}
      >
