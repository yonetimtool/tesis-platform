      ...
      {acik && (
        ...
        >
          ...
          {/* (P244 §2) TESIS SECICI BURADAN KALDIRILDI — kenar cubugunun
              ...
              Gerekce dil secicininkiyle ayni (P140.4): iki yerde birden
              duran bir kontrol "hangisi gecerli?" sorusunu uretir.
              Gecis MANTIGI `lib/tesis-gecis.ts` kancasinda — cizim
              tasindi, karar tek yerde kaldi. */}
