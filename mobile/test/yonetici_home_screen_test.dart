    ...
    await tester.pumpWidget(_app(
      ...
      hareketler: [
        ActivityItem(
          ...
          sunucuBaslik: 'Yeni Talep',
          sunucuAltMetin: 'Asansör',
  ...
  testWidgets('Son Hareketler TEK uctan (/activity) cizilir — istemci '
    ...
    await tester.pumpWidget(_app(hareketler: [
      ActivityItem(
        ...
        baslikKimlik: AkisBaslik.alarmKacirilanTur,
        sunucuBaslik: 'Kaçırılan Tur',
        sunucuAltMetin: 'A Blok turu kaçırıldı',
      ...
      ActivityItem(
        ...
        sunucuAltMetin: 'Çöp toplama — Temizlik',
