...
class AppLocalizationsRu extends AppLocalizations {
  ...
  String get kayitSosyalEpostaNotu =>
      'Этот адрес получен из вашей социальной учётной записи и не может быть изменён.';

  @override
  String get kayitSosyalRelayNotu =>
      'Apple скрыл ваш адрес. Отправка писем на него невозможна; уведомления пересылает Apple.';
