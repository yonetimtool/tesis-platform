...
from .routers import konum as konum_router
from .routers import ozellikler as ozellikler_router
...
app.include_router(kayit_router.router)
app.include_router(davet_router.router)
...
app.include_router(vardiya_izin_router.router)
...
# (P191 §4) Banka entegrasyonu — ekstre -> eslestirme -> defter -> makbuz.
app.include_router(banka_router.router)
...
app.include_router(konum_router.router)
app.include_router(ozellikler_router.router)
